...
<div id="signupbox" style="margin-top: 50px"
  ...
  <legend class="scheduler-border"> <h2>Restore Credentials</h2></legend>
    ...
    <div class="form-group row">
     ...
     <div class="col-md-4 col-md-offset-6" id="icn" style="display: none;"> <span class="glyphicon">&#xe013;</span> <font color="green">User Exists</font></div>
    <div class="col-md-4 col-md-offset-6" id="icn2" style="display: none;">  <span class="glyphicon">&#xe014;</span> <font color="red">User Does Not Exists</font></div>
     ...
     <input type="text" name="ans" class="form-control" id="ans" oninput="answer()"/>
       ...
       <div class="col-md-4 col-md-offset-6" id="icn3" style="display: none;"> <span class="glyphicon">&#xe013;</span> <font color="green">Correct answer</font></div>
    <div class="col-md-4 col-md-offset-6" id="icn4" style="display: none;">  <span class="glyphicon">&#xe014;</span> <font color="red">Incorrect answer</font></div>
     </div>
     ...
     <input type="password" name="pass" class="form-control" id="p1" disabled="disabled" oninput="pas()" />
       ...
       <div class="col-md-4 col-md-offset-6" id="icn5" style="display: none;"> <span class="glyphicon">&#xe013;</span> <font color="green">Password Accurate</font></div>
    <div class="col-md-4 col-md-offset-6" id="icn6" style="display: none;">  <span class="glyphicon">&#xe014;</span> <font color="red">Inaccurate password</font></div>
     ...
     <div class="col-md-4 col-md-offset-6" id="icn7" style="display: none;"> <span class="glyphicon">&#xe013;</span> <font color="green">Password match</font></div>
    <div class="col-md-4 col-md-offset-6" id="icn8" style="display: none;">  <span class="glyphicon">&#xe014;</span> <font color="red">Password do not match</font></div>
     ...
     <div class="col-auto"  >  
        <input type="button" class="btn btn-primary mb-2" id="but" disabled="disabled" value="Click to Reset Credentials" onclick="showForm()"/>
         ...
         <div class="col-md-3" style="display: none;" id="subm" >  
